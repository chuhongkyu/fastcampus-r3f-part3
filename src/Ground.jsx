...
export function Ground() {
  ...
  const gridMap = useLoader(
    TextureLoader,
    process.env.PUBLIC_URL + "/assets/textures/grid.png"
  );

  const aoMap = useLoader(
    TextureLoader,
    process.env.PUBLIC_URL + "/assets/textures/ground-ao.png"
  );

  const alphaMap = useLoader(
    TextureLoader,
    process.env.PUBLIC_URL + "/assets/textures/alpha-map.png"
  );
