  ...
  return(
    <group ref={wheelRef}>
        <group rotation={lefSide ? [0, 0, -Math.PI / 2] :[ 0, 0, Math.PI / 2] } scale={0.04}>
            <mesh castShadow geometry={nodes.Object_10.geometry} material={materials.Tyre} />
            <mesh castShadow geometry={nodes.Object_11.geometry} material={materials['Silver.001']} />
        </group>
    </group>
  );
};
